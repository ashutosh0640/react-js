export default function ProductCard({ image, name, price, size, inStock }) {
    return (
        <>
                ...
                <div className="flex bg-white rounded-lg shadow dark:bg-gray-800 flex-col md:flex-row">
                    ...
                    <form className="flex-auto p-6">
                        <div className="flex flex-wrap">
                            <h1 className="flex-auto text-xl font-semibold dark:text-gray-50">{name}</h1>
                            <div className="text-xl font-semibold text-gray-500 dark:text-gray-300">{price}</div>
                            <div className="flex-none w-full mt-2 text-sm font-medium text-gray-500 dark:text-gray-300">{inStock ? 'In stock' : 'Out of stock'}</div>
                        </div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-300">Free shipping on all continental IND orders.</p>
                    </form>
                </div>
            </div>
